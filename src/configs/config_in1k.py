...
# experiment tag
cfg.exp_code: str = "0.0.1.in1k.slm1b.llama2"
cfg.data_name: tuple[str] = ("in1k",)
cfg.skip_extract_nouns: bool = bool(1)
...
inference part 
"""
cfg.eval_ckpt_path: str = f"{cfg.ckpt_dir}/0.0.1.in1k.slm1b.llama2/ckpt_05_0050045.pth"
...
def optim_filter(model, decay_params: List = [], other_params: List = []):
    """
    optimizer filter for different layers
    """
