...
# experiment tag
cfg.exp_code: str = "0.0.1.g70m.slm1b.llama2"
cfg.data_name: tuple[str] = ("laion115m", "cc3m", "sbu", "coco")
...
inference part 
"""
cfg.eval_ckpt_path: str = f"{cfg.ckpt_root}/x/{cfg.exp_code}/ckpt_03_0414138.pth"
